    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:block">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-20 right-10 h-96 w-96 animate-pulse rounded-full bg-indigo-400/20 blur-3xl" style={{ animationDelay: "1s" }} />
          <div className="absolute left-1/3 top-1/2 h-64 w-64 animate-pulse rounded-full bg-purple-400/15 blur-3xl" style={{ animationDelay: "2s" }} />
        </div>
        {/* Content */}
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-lg text-blue-100/80">
              한국어 위키피디아와 나무위키의 방대한 문서를 빠르게 검색하고 탐색할 수 있습니다.
            </p>
          </div>
      ...
      <div className="flex w-full items-center justify-center bg-zinc-50 px-6 dark:bg-zinc-950 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <p className="mt-6 text-center text-xs text-zinc-400 dark:text-zinc-600">
            로그인하면 위키 검색의 서비스 이용약관에 동의하게 됩니다.
          </p>
        </div>
      </div>
    </div>

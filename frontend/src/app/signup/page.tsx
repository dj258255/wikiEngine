    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:block">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-10 left-20 h-96 w-96 animate-pulse rounded-full bg-pink-400/20 blur-3xl" style={{ animationDelay: "1.5s" }} />
          <div className="absolute right-1/3 top-1/2 h-64 w-64 animate-pulse rounded-full bg-indigo-300/15 blur-3xl" style={{ animationDelay: "0.5s" }} />
        </div>
        {/* Content */}
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-lg text-purple-100/80">
              무료 계정을 만들고 위키피디아와 나무위키의 방대한 지식을 자유롭게 탐색하세요.
            </p>
            <div className="mt-8 flex items-center gap-6">
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white">27M+</span>
                <span className="text-sm text-purple-200/70">문서</span>
              </div>
              <div className="h-8 w-px bg-white/20" />
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white">2</span>
                <span className="text-sm text-purple-200/70">위키 소스</span>
              </div>
              <div className="h-8 w-px bg-white/20" />
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white">AI</span>
                <span className="text-sm text-purple-200/70">요약 지원</span>
              </div>
            </div>
          </div>
      ...
      {/* Right: Signup form */}
      <div className="flex w-full items-center justify-center bg-zinc-50 px-6 dark:bg-zinc-950 lg:w-1/2">
        <div className="w-full max-w-md">
          {/* Mobile logo */}
          <Link href="/" className="mb-8 block text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100 lg:hidden">
            위키 검색
          </Link>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength={100}
                    className={`w-full rounded-xl border bg-zinc-50 py-3 pl-11 pr-4 text-sm text-zinc-900 outline-none transition-all placeholder:text-zinc-400 focus:bg-white focus:ring-4 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500 dark:focus:bg-zinc-800 ${
